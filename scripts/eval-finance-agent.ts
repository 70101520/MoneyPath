  ...
  JSON.stringify(
    {
      ...
      model:
        (process.env.AI_PROVIDER ?? 'ollama') === 'ollama'
          ? process.env.OLLAMA_MODEL ?? 'qwen3.5:4b-q4_K_M'
